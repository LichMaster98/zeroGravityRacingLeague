...
namespace zgrl
{
    internal class Program
    {
        ...
        public static Dictionary<ulong,Classes.Race> games = new Dictionary<ulong, Classes.Race>(); // This will eventually hold the race objects for ZGLR

        public async Task RunBotAsync()
        {

            var file = "timebot.json";
